...
public class IndianStateCode4 {

    public int loadIndianStateCode4(String FILE_PATH) throws StateCodeException {
        try(Reader reader = Files.newBufferedReader(Paths.get(FILE_PATH));){
            ...
            throw new StateCodeException(ex.getMessage(), StateCodeException.ExceptionType.INCORRECT_DELIMITER);
        }
    }
}
