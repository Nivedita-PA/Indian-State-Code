...
public class IndianStateCode3 {

    public int loadIndianStateCode3(String FILE_PATH) throws StateCodeException {
        try {
            ...
            throw new StateCodeException(ex.getMessage(), StateCodeException.ExceptionType.FILE_TYPE_PROBLEM);
        }
    }
}
