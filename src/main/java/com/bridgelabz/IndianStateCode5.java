...
public class IndianStateCode5 {

    public int loadIndianStateCode5(String FILE_PATH) throws StateCodeException {
        try(Reader reader = Files.newBufferedReader(Paths.get(FILE_PATH));){
            ...
            throw new StateCodeException(ex.getMessage(), StateCodeException.ExceptionType.INCORRECT_HEADER);
        }
    }
}
